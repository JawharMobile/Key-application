package com.key.application.repository;

import com.key.application.KeyApplicationApp;
import com.key.application.config.Constants;
import com.key.application.config.audit.AuditEventConverter;
import com.key.application.domain.PersistentAuditEvent;
...
import static com.key.application.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
